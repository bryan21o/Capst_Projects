...
Where are the most accident-prone locations in the United States?
What are the most common causes or contributing factors to accidents?
How do accident rates vary by time (hour, day, month, season)?
What is the relationship between weather conditions and accident severity?
Are there trends in accident severity based on location or time?
How do traffic accidents impact traffic congestion and travel times?
Can we predict the likelihood of an accident occurring at a given time and place?
Project Steps
The project followed these key steps:

Setup the Project: Downloaded the dataset using Kagglehub.
Business Understanding: Define the problem clearly and identify key questions that your analysis should answer. Determine how success will be measured and what insights would be valuable to stakeholders.
Data Understanding: Explore the US Accidents dataset to understand its structure, variables, scope, and limitations. Identify potential issues with the data and assess its suitability for addressing the business problem.
...
Statistical Analysis: pply appropriate statistical methods to identify patterns, correlations, and significant factors.
